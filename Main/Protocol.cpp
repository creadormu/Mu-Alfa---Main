		...
		case 0x7A:
			...
			case 0xFB:
				switch(((lpMsg[0]==0xC1)?lpMsg[3]:lpMsg[4]))
				{
					...
					return 1;
					case 0x35:
						gRecvGS.GetInfoRankTitle((PMSG_RANKTITLE_UPD*)lpMsg);
						break;
					case 0x36:
						gRecvGS.GetInfoRankTitle1((PMSG_QUAN_HAM_UPD*)lpMsg);
						break;
					case 0x37:
						gRecvGS.GetInfoRankTitle2((PMSG_TU_LUYEN_UPD*)lpMsg);
						break;
						break;
					case 0x38:
					...
					case 0x15:
						...
						break;
					case 0x10:
						g_ExWinQuestSystem.GC_MiniInfoRecvEx((GC_ExWinMiniInfoEx*)lpMsg);
						return 1;
					case 0x11:
						g_ExWinQuestSystem.GC_Start((GC_ExWinStart*)lpMsg);
						return 1;
					case 0x12:
						g_ExWinQuestSystem.GC_RecvMain((GC_MainPacket*)lpMsg);
						return 1;
					case 0x13:
						g_ExWinQuestSystem.GC_MiniInfoRecv((GC_ExWinMiniInfo*)lpMsg);
						return 1;
				}
				break;
		case 0xF5:
...
{
	gInterface.m_LuckyWheelEnabled = lpMsg->LuckyWheelEnabled;
	gInterface.m_LuckyWheelWCoinC = lpMsg->LuckyWheelWCoinC;
	gInterface.m_LuckyWheelWCoinP = lpMsg->LuckyWheelWCoinP;
	gInterface.m_LuckyWheelGPCoin = lpMsg->LuckyWheelGPCoin;
	gInterface.m_LuckyWheelTime = lpMsg->LuckyWheelTime;
}
